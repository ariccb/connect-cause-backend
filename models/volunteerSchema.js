...
const volunteerSchema = new mongoose.Schema({
    ...
    password: { type: String, required: true }, // i add this to the schema
    created_at: { type: Date, default: new Date() },
    birth_date: { type: Date, required: true }, // i add this to the schema
    updated_at: { type: Date, required: false },
    interests: [String], // add interests field as an array of strings
  about_me: { type: String, required: false }, // add about_me field as a string
